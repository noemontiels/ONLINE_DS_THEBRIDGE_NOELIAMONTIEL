...
def plot_categorical_numerical_relationship(df, categorical_col, numerical_col, show_values = False, measure = 'mean'):
    ...
    # Si hay más de 10 categorías, las divide en grupos de 10
...
def scatterplot_with_correlation(df, column_x, column_y, dot_size = 50, show_correlation = False):
    ...
    - dot_size (int, optional): Size of the points in the chart. Default is 50.
    - show_correlation (bool, optional): If True, shows the correlation in the chart. Default is False.
    """
